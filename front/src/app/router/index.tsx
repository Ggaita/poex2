...
import IndustrialParkPage from "../../pages/IndustrialPark/IndustrialParkPage";
...
import AdminCommunicationsPage from "../../pages/AdminCommunications/AdminCommunicationsPage";
import AdminSpecialRequestsPage from "../../pages/AdminSpecialRequests/AdminSpecialRequestsPage";
  ...
  return (
    <Routes>
      ...
      <Route element={<RequireRoleRoute allowedRoles={["admin"]} />}>
        ...
        <Route path="/admin/special-requests" element={<AdminSpecialRequestsPage />} />
      </Route>
