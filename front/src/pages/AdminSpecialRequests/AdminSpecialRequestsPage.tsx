      ...
      <section className="admin-special-requests-page">
        <div className="admin-special-requests-shell">
          <header className="admin-special-requests-header">
            ...
            <small>
              Gestioná solicitudes de producto necesario u oferta especial recibidas desde la búsqueda pública.
            </small>
          </header>
                  ...
                  <section className="special-decision-panel">
                    ...
                    <label>
                      ...
                      >
                        ...
                        <option value="in_review">En revisión</option>
                        <option value="forwarded">Derivado</option>
                    ...
                    <label>
                      ...
                      <textarea
                        ...
                        placeholder="Acciones realizadas, empresas sugeridas, seguimiento..."
                      />
                    </label>
