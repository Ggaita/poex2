...
if (!detailResponse.ok || !detailResult.success) {
  ...
  const handleCreateMapLocationChange = (coords: {
    latitude: number;
    longitude: number;
  }): void => {
    setCreateFormState((prev) => ({
  ...
  const openCreateCompanyForm = (): void => {
  ...
  const closeCreateCompanyForm = (): void => {
...
<button
                      ...
                      className={
                        !showCreateForm && selectedId === row.id
                          ? "profile-row active"
                          : "profile-row"
                      }
                    >
...
<section className="profile-detail-card">
              {showCreateForm ? (
                <form className="create-company-card" onSubmit={handleCreateProfile}>
                  <header>
                    <h3>Alta de empresa (admin)</h3>
                    <p>
                      Completá los datos principales de la empresa. El perfil queda
                      disponible de inmediato para edición, publicación y carga de
                      productos.
                    </p>
                  </header>
                    ...
                    <div className="create-company-grid">
                      ...
                      <label>
                        ...
                        <input
                          ...
                          onChange={handleCreateFormChange}
                          disabled={isCreatingProfile}
                          placeholder="Agroindustria, Forestal..."
                        />
                      </label>
                      <label>
                        Subsector
                        <input
                          name="subSector"
                          value={createFormState.subSector}
                          onChange={handleCreateFormChange}
                          disabled={isCreatingProfile}
                        />
                      </label>
                  ...
                  <section className="create-company-section">
                    ...
                    <div className="create-company-grid">
                      ...
                      <label>
                        ...
                        <input
                          name="latitude"
                          value={createFormState.latitude}
                          onChange={handleCreateFormChange}
                          disabled={isCreatingProfile}
                      ...
                      <label>
                        ...
                        <input
                          name="longitude"
                          value={createFormState.longitude}
                          onChange={handleCreateFormChange}
                          disabled={isCreatingProfile}
                          placeholder="-58.986543"
                        />
                      </label>
                      <div className="full admin-map-block">
                        ...
                        <OsmLocationPicker
                          latitude={parseNullableNumber(createFormState.latitude)}
                          longitude={parseNullableNumber(createFormState.longitude)}
                          onChange={handleCreateMapLocationChange}
                        />
                      </div>
                    </div>
                  </section>
                  ...
                  <section className="create-company-section">
                    ...
                    <div className="create-company-grid">
                      ...
                      <label>
                        ...
                        <input
                          name="keywords"
                          value={createFormState.keywords}
                          onChange={handleCreateFormChange}
                          disabled={isCreatingProfile}
                        />
                      </label>
                  ...
                  <div className="create-company-actions">
                    <button
                      type="button"
                      className="secondary"
                      onClick={closeCreateCompanyForm}
                      disabled={isCreatingProfile}
                    >
                      Cancelar
                    </button>
              ...
              {!showCreateForm && isDetailLoading ? (
                <p className="detail-feedback">Cargando detalle del perfil...</p>
              ) : null}

              {!showCreateForm && !isDetailLoading && !selectedProfile ? (
                <p className="detail-feedback">
                  Seleccioná un perfil para editar datos, publicación y visibilidad, o
                  creá una empresa nueva.
                </p>
              ) : null}
